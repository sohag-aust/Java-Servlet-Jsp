...
<body> 
	<form action="answer.jsp" method="get">
		...
		var ok = 0;
			...
			setTimeout("window.open('answer.jsp')", 60000);
    ...
    <p>
			...
			<%
				 ...
				 qry = "select * from `add_qstn` where id = 1";
			...
			<%
				 qry = "select * from `add_qstn` where id = 2";
			 	 rs = st.executeQuery(qry);
			  	 rs.next();
			%>
			...
			<%
				 qry = "select * from `add_qstn` where id = 3";
			 	 rs = st.executeQuery(qry);
			  	 rs.next();
			%>
			...
			<%
				 qry = "select * from `add_qstn` where id = 4";
			 	 rs = st.executeQuery(qry);
			  	 rs.next();
			%>
			...
			<%
				 qry = "select * from `add_qstn` where id = 5";
			 	 rs = st.executeQuery(qry);
			  	 rs.next();
			%>
			...
			<%
				 qry = "select * from `add_qstn` where id = 6";
			 	 rs = st.executeQuery(qry);
			  	 rs.next();
			%>
			...
			<%
				 qry = "select * from `add_qstn` where id = 7";
			 	 rs = st.executeQuery(qry);
			  	 rs.next();
			%>
			...
			<%
				 qry = "select * from `add_qstn` where id = 8";
			 	 rs = st.executeQuery(qry);
			  	 rs.next();
			%>
			...
			<%
				 qry = "select * from `add_qstn` where id = 9";
			 	 rs = st.executeQuery(qry);
			  	 rs.next();
			%>
			...
			<%
				 qry = "select * from `add_qstn` where id = 10";
			 	 rs = st.executeQuery(qry);
			  	 rs.next();
			%>
